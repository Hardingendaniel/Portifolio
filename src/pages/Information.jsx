...
const Card = ({ frontContent, backContent, targetId }) => {
  ...
  return (
    <ReactCardFlip flipDirection="vertical" isFlipped={isFlipped}>
      ...
      <div className="kort-bakside" onClick={flipCard}>
        {backContent}
        <button className="button-reset" onClick={() => scrollToEvent(targetId)}>
          <text className="kort-tekst2">Scroll til opplevelser</text>
        </button>
      </div>
    </ReactCardFlip>
  );
          ...
          <Card
            ...
            backContent={
              <><text className="kort-tekst">Løpserfaring</text>
                <text className="kort-tekst">har fullført backyard ultra</text>
